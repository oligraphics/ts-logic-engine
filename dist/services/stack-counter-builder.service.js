...
exports.StackCounterBuilderService = new (class StackCounterBuilderService {
    build(configuration, action) {
        ...
        if (configuration.event) {
            counter.triggers.push(counter_trigger_builder_service_1.CounterTriggerBuilderService.build(configuration, builtin_trigger_type_enum_1.BuiltinTriggerTypeEnum.COUNTER, counter_method_enum_1.CounterMethodEnum.REDUCE, 1, action));
        }
