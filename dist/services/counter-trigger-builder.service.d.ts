...
export declare const CounterTriggerBuilderService: {
    buildAll(configurations: CounterTriggerDto[], defaultMethod: CounterMethodEnum, defaultAmount: number, action: IActionInstance): ICounterTriggerInstance[];
    build(configuration: CounterTriggerDto, defaultMethod: CounterMethodEnum, defaultAmount: number, action: IActionInstance): ICounterTriggerInstance;
};
