...
exports.CustomTriggerBuilderService = void 0;
...
exports.CustomTriggerBuilderService = new (class CustomTriggerBuilderService {
    ...
    build(configuration, action) {
        return {
            ...
            type: builtin_trigger_type_enum_1.BuiltinTriggerTypeEnum.CUSTOM,
            ...configuration,
            action,
        };
    }
})();
//# sourceMappingURL=custom-trigger-builder.service.js.map