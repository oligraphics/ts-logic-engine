...
export declare class EventSystem {
    ...
    _callCanceled(eventListeners: EventListeners, source: IEventSource, event: EventDto): void;
    _callPhase(eventListeners: EventListeners, source: IEventSource, event: EventDto, phase: EventPhaseEnum): boolean;
